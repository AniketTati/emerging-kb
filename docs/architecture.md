...
2. **Wave B scope built:** NotebookLM-style artifacts (briefing/FAQ/mind map/suggested Qs) + HippoRAG-2 graph for multi-hop. HalluGraph + audio overview deferred to Wave C (cited as future work).

...
### 5.7 Phase 3a plan — Chunking (G1 ✅ + G2 ✅ + G3 ✅ SIGNED OFF)

> **Status:** G1 ✅ + G2 ✅ + G3 ✅ all signed off 2026-05-23. Plan + single contract delta + 16 red skeletons (9 unit + 7 worker) locked. Branch: `phase-3/chunking-raptor` off `main` (Phase 2b merged as PR #6 · merge commit `971a019`).

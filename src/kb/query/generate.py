...
_SYSTEM_PROMPT = (
    ...
    "When MULTIPLE snippets support the same claim, emit ONE bracket "
    "per snippet back-to-back: \"...are net-45 [a8b21618] [3f782075]\" "
    "— do NOT comma-join inside a single bracket "
    "(\"[a8b21618, 3f782075]\" is wrong; the UI renders that as a raw "
    "UUID string instead of a clickable chip).\n"

...
_ROUTING_SYSTEM_PROMPT = (
    ...
    "\"field_filters\": list[{\"field\": str, \"op\": str, \"value\": any}], "
    "\"notes\": str|null}.\n\n"
    ...
    "  F — filter whole DOCUMENTS by a predicate on the document's own\n"
    "      fields ('which loans have interest_rate > 9', 'contracts where\n"
    "      governing_law = Delaware'). Carry predicates in field_filters as\n"
    "      [{\"field\": <snake_case field name>, \"op\": one of\n"
    "      eq/ne/lt/le/gt/ge/like/in, \"value\": <bare number or string, no\n"
    "      %/units/commas>}]. Prefer F over C when the subject is a DOCUMENT\n"
    "      type (loan, contract, invoice), not a row type (transaction,\n"
    "      clause, line item).\n"
    ...
    "  'which loans have an interest rate over 9%' → F\n"
